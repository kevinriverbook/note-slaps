              ...
              <div class="p-6 text-gray-900 dark:text-gray-100">
                  ...
                  <form method="POST" action="{{ route('notes.update', $note->id) }}" class="space-y-4">
                    ...
                    <div>
                      ...
                      <input type="text" value="{{ $note->note_title }}" name="note_title" id="note_title" class="mt-1 w-full dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm" />
                    </div>
                    <!-- メモ本文 -->
                    <div>
                      <label for="note_content" class="font-medium text-sm text-gray-700 dark:text-gray-300">メモ</label>
                      <textarea name="note_content" id="note_content" class="mt-1 w-full dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm">{{ $note->note_content }}</textarea>
                    </div>
                    <!-- 送信ボタン -->
                    <div>
